...
Several changes have been made to make it compatible with Unity, libraries have been replaced and external dependencies have been reduced. The API and documentation remain unchanged. The original tests are run on every commit.
...
The [Solana.Unity.Examples](https://github.com/bmresearch/Solnet/tree/master/src/Solana.Unity.Examples/) project contains some code examples,
...
The [Solana.Unity.Wallet](https://github.com/bmresearch/Solnet/tree/master/src/Solana.Unity.Wallet/) project implements wallet and key generation features, these were made compatible
